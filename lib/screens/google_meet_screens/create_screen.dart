import 'package:mentearn/google_meet/event_info.dart';
import 'package:mentearn/components/color.dart';
import 'package:mentearn/google_meet/calendar_client.dart';
import 'package:mentearn/google_meet/storage.dart';
import 'package:flutter/material.dart';
import 'package:googleapis/calendar/v3.dart' as calendar;
import 'package:intl/intl.dart';

class CreateScreen extends StatefulWidget {
  static const String id = 'createScreen';
            ...
            child: SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'This will add a new meeting to the meetings list. You can also add video conferencing option and choose to notify the attendees of this event.',
                      style: TextStyle(
                    ...
                    SizedBox(height: 10),
                    Text(
                      'You will have access to modify or remove the meeting afterwards.',
                      style: TextStyle(
                        color: Colors.grey,
                        fontFamily: 'Raleway',
                        fontSize: 16,
